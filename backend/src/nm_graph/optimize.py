...
from .nmgraph import NMGraph, EdgeSource, IteratorNode, Node
...
def __outline_child_nodes(chain: NMGraph) -> bool:
    """
...
def __removed_dead_nodes(chain: NMGraph) -> bool:
    """
