...
@NodeFactory.register("machines:chart:chart_plugin")
class AutoChartController(NodeBase):
    def __init__(self):
        super().__init__()
        self.description = "Takes in a json and returns a chart type and chart data"
        self.inputs = [
    ...
    def run(self, model: str, message_in_sub: AsyncSubject) -> AsyncSubject:
        self.consumer_subject = message_in_sub
