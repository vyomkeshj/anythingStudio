...
const downloads: Record<SupportedPlatform, string> = {
    linux: 'https://github.com/MachinesStudio-org/ffmpeg-rehost/releases/download/ffmpeg/ffmpeg-linux-x64.zip',
    darwin: isArmMac
        ? 'https://github.com/MachinesStudio-org/ffmpeg-rehost/releases/download/ffmpeg/ffmpeg-darwin-arm64.zip'
        : 'https://github.com/MachinesStudio-org/ffmpeg-rehost/releases/download/ffmpeg/ffmpeg-darwin-x64.zip',
    win32: 'https://github.com/MachinesStudio-org/ffmpeg-rehost/releases/download/ffmpeg/ffmpeg-win32-x64.zip',
};
