...
export const setMainMenu = ({ mainWindow, menuData, enabled = false }: MainMenuArgs) => {
    ...
    const template = [
        ...
        },
        {
            ...
            submenu: [
                {
                    label: "Open MachinesStudio's GitHub page",
                    click: async () => {
                        await shell.openExternal(
                            'https://github.com/MachinesStudio-org/MachinesStudio/blob/main/README.md'
                        );
                    },
                },
                {
