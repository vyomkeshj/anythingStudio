...
import { formatTextPattern, padCenter, padEnd, padStart, splitFilePath } from './machines-builtin';
...
export const getMachinesStudioScope = lazy((): Scope => {
    const builder = new ScopeBuilder('Machines scope', globalScope);
