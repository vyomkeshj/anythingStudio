...
const AppearanceSettings = memo(() => {
    ...
    return (
        ...
        >
            <Toggle
                description="Use dark mode throughout MachinesStudio."
                title="Dark theme"
                value={isDarkMode}
                onToggle={() => {
...
const EnvironmentSettings = memo(() => {
    ...
    return (
        ...
        >
            <SettingsItem
                description="Set a chain template to use by default when MachinesStudio starts up."
        ...
        >
            ...
            <TabPanels px={0}>
                <TabPanel px={0}>
                    ...
                    >
                        <Toggle
                            description="Use system Python for MachinesStudio's processing instead of the bundled Python (not recommended)"
...
const AdvancedSettings = memo(() => {
    ...
    return (
        ...
        >
            <Toggle
                description="Disable GPU hardware acceleration for rendering MachinesStudio's UI. Only disable this is you know hardware acceleration is causing you issues."
