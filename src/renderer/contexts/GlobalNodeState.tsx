    ...
    ({ children, reactFlowWrapper }: React.PropsWithChildren<GlobalProviderProps>) => {
        ...
        useEffect(() => {
            const id = setTimeout(() => {
                ...
                document.title = `MachinesStudio - ${savePath || 'Untitled'}${dot}`;
            }, 200);
            ...
            async (savedData: ParsedSaveData, path: string, loadPosition = false) => {
                ...
                if (savedData.tamperedWith) {
                    sendAlert({
                        ...
                        message:
                            'The file you are trying to open has been modified outside of MachinesStudio. The modifications may cause MachinesStudio to behave incorrectly or in unexpected ways. The file will now be loaded with the modifications.',
                    });
                }
                ...
                if (deprecatedNodes.length > 0) {
                    ...
                    sendAlert({
                        ...
                        message: `This file contains the following deprecated node(s):\n\n${list}\n\nThis chain will still work right now, but these nodes will stop working in future versions of Machines.`,
                    });
                }
        ...
        const exportViewportScreenshot = useCallback(() => {
            ...
            const fileName = `MachinesStudio-${currentChainName}-${dateString}_${timeString}.png`;
